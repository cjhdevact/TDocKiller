...
del /q "%windir%\PolicyDefinitions\en-US\TDocKiller.adml"

rd /s /q "%systemdrive%\ProgramData\Microsoft\Windows\Start Menu\Programs\一键关闭课件小工具"
...
if "%a%" == "1" Reg delete HKCU\Software\CJH\TDocKiller /f

Reg delete HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\TDocKiller /v DisplayIcon /f
Reg delete HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\TDocKiller /v DisplayName /f
Reg delete HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\TDocKiller /v Publisher /f
Reg delete HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\TDocKiller /v UninstallString /f

cd /d "%windir%"
rd /s /q "%programfiles%\CJH\TDocKiller"
